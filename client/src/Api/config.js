...
const api = axios.create({
  baseURL: import.meta.env.VITE_BACKEND_URL || "https://lms-backend-git-master-jagadeeshreddy14s-projects.vercel.app/api", // Backend base URL
    ...
    if (error.response?.status === 401 && !originalRequest._retry) {
      ...
      try {
        ...
        const refreshResponse = await axios.post(
          `${import.meta.env.VITE_BACKEND_URL || "https://lms-backend-git-master-jagadeeshreddy14s-projects.vercel.app/api"}/auth/refresh-token`,
          {},
          {
